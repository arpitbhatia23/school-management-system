                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="text" placeholder="Enter student name" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        ...
                        <Selectcomp selectLable="select your gender" selectvalue="Gender" selectItems={["male","female","transgender"]} field={field}/>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="tel" placeholder="Enter phone no." {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="text" placeholder="Enter class" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        ...
                        <Selectcomp selectLable="select blood group" selectvalue="Blood Group" field={field}  selectItems={['A_pos', 'A_neg', 'B_pos', 'B_neg', 'O_pos', 'O_neg', 'AB_pos', 'AB_neg']}/>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="text" placeholder="Enter religion" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
               ...
               <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Selectcomp selectLable="select your category" selectvalue="Category" selectItems={['GENERAL', 'OBC', 'SC', 'ST']} field={field}/>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
               ...
               <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="tel" placeholder="Enter  parents phone no." {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                 ...
                 <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="email" placeholder="Enter parents email" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
               ...
               <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="text" placeholder="Enter  father name" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                 ...
                 <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="text" placeholder="Enter mother name" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                 ...
                 <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="text" placeholder="Enter father occupation" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
...
<CardContent className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 items-center sm:items-start  justify-items-center p-2">
  ...
  <CardTitle className=" font-semibold text-center">UPLOAD STUDENT PHOTO </CardTitle>
                 <FormField
                  name="profile_image"
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormControl>
                        <Input type="file" placeholder="chose student photo" {...field} onChange={(e)=>{handelimage(e)  ;field.onChange(e)}}  />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
      ...
      <button type="submit"   className="bg-orange-500 p-2 h-12 w-28">
      {loading ? "Submitting..." : "Submit"}      </button>
      <button type="submit" className="bg-green-500 p-2 h-12 w-28" onClick={()=>{form.reset() ; setimage(profileimg); setimageform(null);} }>
        reset
      </button>
      </div>
