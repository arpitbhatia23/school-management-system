...
import { addsuject, getAllParents, getallsubject, getAllTeacher, getStudent ,getStudentById, getTeacherById, promoteStudents,getParentsById,addNewExpense,getAllExpense, updateSubject} from "../controllers/admin.controller.js";
const router =Router()
...
router.route('/getparentsById').get(verifyJwt,verifyAdmin,getParentsById)
router.route('/addNewExpense').post(verifyJwt,verifyAdmin,addNewExpense)
router.route('/getAllExpense').get(verifyJwt,verifyAdmin,getAllExpense)
