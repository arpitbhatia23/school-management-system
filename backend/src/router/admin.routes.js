...
import { addsuject, getAllParents, getallsubject, getAllTeacher, getStudent ,getStudentById, getTeacherById, promoteStudents} from "../controllers/admin.controller.js";
const router =Router()
